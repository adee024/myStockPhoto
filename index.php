...
background: linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(253,187,45,0.6306897759103641) 94%);
}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
								   ...
								   <input type="email" id="inputEmail" class="form-control" placeholder="email" name="email"required autofocus>
									...
									<input type="password" id="inputPassword" class="form-control" placeholder="password again" name="password_2" required>
									</br>
...
<div id="section3" style="padding-top:90px;padding-bottom:70px">
   <div class="col-xs-12 col-md-4 col-lg-4">
    ...
    <form method="post" action="SERVER-PHP/mail.php" id="mailForm">

        <div class="form-group">
            <label for="exampleFormControlInput2">Full name</label>
            <input type="text" class="form-control" id="exampleFormControlInput2" name="name" placeholder="your full name">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" name="message" placeholder="message" rows="3"></textarea>
        </div>
